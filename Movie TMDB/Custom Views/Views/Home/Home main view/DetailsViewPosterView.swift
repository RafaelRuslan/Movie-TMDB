...
struct DetailsViewPosterView: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 25) {
                ...
                HStack(spacing: 20) {
                    ...
                    Button {
                        movieVM.addToMylistDetails(movieDetails: movie)
...
#Preview {
    ...
    DetailsViewPosterView(movie: MovieDetails(id: 0, title: "", overview: "", releaseDate: "", runtime: 1, voteAverage: 1, voteCount: 1, posterPath: "", backdropPath: "", genres: [Genre(id: 1, name: "")], originalLanguage: ""))
